pipeline {
    ...
    environment {
        ...
        recipientEmails="alan.roy.zoro@gmail.com"
        NEXUS_VERSION="nexus3"
        NEXUS_PROTOCOL="http"
        NEXUS_URL="127.0.0.1:8088"
        NEXUS_REPOSITORY="maven-alan-repo"
        NEXUS_CREDENTIAL_ID="nexus-user-credentials"
        IMAGE_TEST="alankairosds/msvc-test"
    }
    ...
    stages {
        ...
        stage('Publish Artifacts') {
            steps {
                script {
                    ...
                    pom_test = readMavenPom file: "./msvc-test/pom.xml";
                    ...
                    nexusArtifactUploader (
                        ...
                        artifacts: [
                            [
                                artifactId: pom_test.artifactId,
                                classifier: '',
                                file: './msvc-test/target/' + pom_test.artifactId + '-' + pom_parent.version + '.jar',
                                type: 'jar'
                            ],
                            [
        ...
        stage('Build Docker Images') {
            steps {
                sh "docker build -t $IMAGE_TEST . -f ./msvc-test/docker/Dockerfile"
            }
        }
